...
class CallSoundManager {
    ...
    private fun setVolume() {
        val volume = ScreenInfoManager.instance.volumeInfo.toIntOrNull() ?: 1
    ...
    private fun makePlayList(callNum:Int, callWinNum:Int, isVIP:Boolean = false) {
        ...
        val repeatCount = ScreenInfoManager.instance.callInfo.toIntOrNull() ?: 1  //호출 반복횟수
        val bellFileName = ScreenInfoManager.instance.bellInfo
        val ment = ScreenInfoManager.instance.ment
